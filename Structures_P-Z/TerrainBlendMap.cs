...
public class TerrainBlendMap : TerrainMap<byte>
{
  ...
  {
    if (Object.op_Inequality((Object) this.BlendTexture, (Object) null))
    {
      if (((Texture) this.BlendTexture).get_width() == ((Texture) this.BlendTexture).get_height())
      {
        this.res = ((Texture) this.BlendTexture).get_width();
        ...
        Debug.LogError((object) ("Invalid alpha texture: " + ((Object) this.BlendTexture).get_name()));
    }
    else
    {
      ...
      for (int index1 = 0; index1 < this.res; ++index1)
      {
        for (int index2 = 0; index2 < this.res; ++index2)
          this.dst[index1 * this.res + index2] = (byte) 0;
      }
    }
  }
  ...
  {
    this.BlendTexture = new Texture2D(this.res, this.res, (TextureFormat) 1, true, true);
    ((Object) this.BlendTexture).set_name("BlendTexture");
    ((Texture) this.BlendTexture).set_wrapMode((TextureWrapMode) 1);
