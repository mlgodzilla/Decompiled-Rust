...
namespace Apex.AI
{
  public static class AINameMap
  {
    ...
    public static readonly Guid HTNDomainAnimalBear = new Guid("f7700d92-e54e-4a7f-9759-341bf82097f4");
    public static readonly Guid HTNDomainMurderer = new Guid("097b2c2f-0a52-47a0-902e-b4b96c601353");
    public static readonly Guid HTNDomainNPCTurret = new Guid("87cb4764-1606-4df9-b8fd-25770ac218c6");
    public static readonly Guid HTNDomainScientistAStar = new Guid("cade7ac7-b198-4454-8974-819023cd328a");
    public static readonly Guid HTNDomainScientistAStarTestCargoShip = new Guid("4085fb83-40de-43e8-bb2f-e978ba371c35");
    public static readonly Guid HTNDomainScientistJunkpile = new Guid("f402b4f6-2401-4ac6-9784-687e6ae8b27c");
    public static readonly Guid HTNDomainScientistMilitaryTunnel = new Guid("9dad0a1f-e2e2-49a2-8f47-4e9a667ab2f1");
    ...
    public static readonly Guid NpcHumanBanditGuard = new Guid("bc0a8fd4-cd5f-4d6e-8f36-27c30a6032e7");
    public static readonly Guid NpcHumanScientist = new Guid("157ef1da-b58a-4092-9267-4458c850fc48");
    public static readonly Guid NpcHumanScientistCH47 = new Guid("b1348460-0648-4c6a-98b0-59a9da4a639c");
    public static readonly Guid NpcHumanScientistJunkpile = new Guid("3b746da6-6aef-403e-9806-365d11a9ff48");
    ...
    public static readonly Guid NpcHumanScientistTacticalMountable = new Guid("5c3b0c47-07ef-4b8b-811d-d3881c226772");
    public static readonly Guid NpcHumanScientistTargetSelectorCover = new Guid("fc26fe11-9167-451f-b718-3bc6cdccd84a");
    public static readonly Guid NpcHumanScientistTargetSelectorEnemyHideout = new Guid("436adfad-b17b-4f81-a0e8-213e660b5d63");
    public static readonly Guid NpcHumanScientistTargetSelectorOtherEntities = new Guid("e9048c4d-d032-4ffb-9aac-71846f2f1742");
    public static readonly Guid NpcHumanScientistTargetSelectorPlayer = new Guid("e8bae2d4-b6ff-40cc-911e-632c739ac441");
    public static readonly Guid NpcHumanScientistTargetSelectorPlayerMounted = new Guid("eac40400-12da-4905-9f5f-281ca2a8ba88");
