...
// Type: Rust.Ai.TimeSinceLastMoveToCoverThreshold
...
namespace Rust.Ai
{
  public class TimeSinceLastMoveToCoverThreshold : BaseScorer
  {
    ...
    {
      return TimeSinceLastMoveToCoverThreshold.Evaluate(c as NPCHumanContext, this.minThreshold, this.maxThreshold) ? 1f : 0.0f;
    }
