...
namespace Rust.Ai
{
  public class IsTargetDead : BaseScorer
  {
    public override float GetScore(BaseContext ctx)
    {
      ...
      return c != null && IsTargetDead.Test(c) ? 1f : 0.0f;
    }

    public static bool Test(NPCHumanContext c)
    {
      if (Object.op_Equality((Object) c.Human.AttackTarget, (Object) null) || c.Human.AttackTarget.IsDestroyed || Object.op_Inequality((Object) c.EnemyPlayer, (Object) null) && c.EnemyPlayer.IsDead() || Object.op_Inequality((Object) c.EnemyNpc, (Object) null) && c.EnemyNpc.IsDead())
        return true;
