...
// Type: Rust.Ai.HTN.Scientist.Reasoners.EnemyRangeReasoner
  ...
  public class EnemyRangeReasoner : INpcReasoner
  {
    ...
    public void Tick(IHTNAgent npc, float deltaTime, float time)
    {
      ...
      if (Object.op_Equality((Object) npcContext.Memory.PrimaryKnownEnemyPlayer.PlayerInfo.Player, (Object) null))
        npcContext.SetFact(Rust.Ai.HTN.Scientist.Facts.EnemyRange, EnemyRange.OutOfRange, true, true, true);
      ...
      {
        npcContext.SetFact(Rust.Ai.HTN.Scientist.Facts.EnemyRange, EnemyRange.CloseRange, true, true, true);
      }
      else
      {
        ...
        {
          npcContext.SetFact(Rust.Ai.HTN.Scientist.Facts.EnemyRange, EnemyRange.MediumRange, true, true, true);
        }
        else
        {
          float num3 = npcContext.Body.AiDefinition.Engagement.SqrLongRangeFirearm(firearm);
          if ((double) sqrMagnitude <= (double) num3)
            npcContext.SetFact(Rust.Ai.HTN.Scientist.Facts.EnemyRange, EnemyRange.LongRange, true, true, true);
          else
            npcContext.SetFact(Rust.Ai.HTN.Scientist.Facts.EnemyRange, EnemyRange.OutOfRange, true, true, true);
        }
      }
