...
// Type: Rust.Ai.HTN.Scientist.Reasoners.CoverPointsReasoner
...
namespace Rust.Ai.HTN.Scientist.Reasoners
{
  public class CoverPointsReasoner : INpcReasoner
  {
    ...
    public void Tick(IHTNAgent npc, float deltaTime, float time)
    {
      ...
      if (npcContext == null)
        return;
      npcContext.SetFact(Rust.Ai.HTN.Scientist.Facts.HasNearbyCover, npcContext.CoverPoints.Count > 0 ? 1 : 0, true, true, true);
      if (!npcContext.IsFact(Rust.Ai.HTN.Scientist.Facts.HasEnemyTarget))
      {
