...
// Type: Rust.Ai.HTN.Scientist.Reasoners.AnimalReasoner
    ...
    public void Tick(IHTNAgent npc, float deltaTime, float time)
    {
      ...
      if (Object.op_Inequality((Object) animal, (Object) null))
      {
        ...
        if ((double) num < (double) npc.AiDefinition.Engagement.SqrCloseRangeFirearm(firearm))
        {
          ...
          npcContext.SetFact(Rust.Ai.HTN.Scientist.Facts.NearbyAnimal, true, true, true, true);
          return;
        }
      }
      npcContext.SetFact(Rust.Ai.HTN.Scientist.Facts.NearbyAnimal, false, true, true, true);
    }
  }
}
