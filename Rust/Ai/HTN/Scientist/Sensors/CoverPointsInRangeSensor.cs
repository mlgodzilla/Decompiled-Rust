...
// Type: Rust.Ai.HTN.Scientist.Sensors.CoverPointsInRangeSensor
  ...
  public class CoverPointsInRangeSensor : INpcSensor
  {
      ...
      float maxDistanceToCoverSqr)
    {
      ...
      if ((double) time > (double) nextTime)
      {
        ...
        if ((Object.op_Equality((Object) volume, (Object) null) || !volume.Contains(position)) && (Object.op_Inequality((Object) SingletonComponent<AiManager>.Instance, (Object) null) && ((Behaviour) SingletonComponent<AiManager>.Instance).get_enabled()) && ((AiManager) SingletonComponent<AiManager>.Instance).UseCover)
        {
