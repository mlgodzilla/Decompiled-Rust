...
// Type: Rust.Ai.HTN.ScientistJunkpile.Sensors.CoverPointsInRangeSensor
...
namespace Rust.Ai.HTN.ScientistJunkpile.Sensors
{
  ...
  public class CoverPointsInRangeSensor : INpcSensor
  {
    ...
    public void Tick(IHTNAgent npc, float deltaTime, float time)
    {
      ...
      this._FindCoverPointsInVolume(npc.transform.get_position(), aiDomain.ScientistContext.CoverPoints, ref aiDomain.ScientistContext.CoverVolume, ref this.nextCoverPosInfoTick, time, aiDomain.ScientistContext.Location, allowedCoverRangeSqr);
    }
      ...
      float maxDistanceToCoverSqr)
    {
      ...
      if ((double) time > (double) nextTime)
      {
        ...
        if (Object.op_Inequality((Object) location.DynamicCoverPointVolume, (Object) null))
          volume = location.DynamicCoverPointVolume;
        else if ((Object.op_Equality((Object) volume, (Object) null) || !volume.Contains(position)) && (Object.op_Inequality((Object) SingletonComponent<AiManager>.Instance, (Object) null) && ((Behaviour) SingletonComponent<AiManager>.Instance).get_enabled()) && ((AiManager) SingletonComponent<AiManager>.Instance).UseCover)
        {
