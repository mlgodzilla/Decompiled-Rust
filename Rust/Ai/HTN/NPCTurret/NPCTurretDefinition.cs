...
// Type: Rust.Ai.HTN.NPCTurret.NPCTurretDefinition
...
namespace Rust.Ai.HTN.NPCTurret
{
  ...
  public class NPCTurretDefinition : BaseNpcDefinition
  {
    ...
    public override BaseCorpse OnCreateCorpse(HTNPlayer target)
    {
      ...
      {
        NPCPlayerCorpse npcPlayerCorpse = target.DropCorpse(string.IsNullOrEmpty(this.CorpsePath) ? "assets/prefabs/npc/scientist/scientist_corpse.prefab" : this.CorpsePath) as NPCPlayerCorpse;
