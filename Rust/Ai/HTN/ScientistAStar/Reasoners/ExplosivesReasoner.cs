...
// Type: Rust.Ai.HTN.ScientistAStar.Reasoners.ExplosivesReasoner
    ...
    public void Tick(IHTNAgent npc, float deltaTime, float time)
    {
      ...
      for (int index = 0; index < npcContext.Memory.KnownTimedExplosives.Count; ++index)
      {
        ...
        if (Object.op_Inequality((Object) knownTimedExplosive.Entity, (Object) null))
        {
          ...
          {
            npcContext.SetFact(Rust.Ai.HTN.ScientistAStar.Facts.NearbyExplosives, true, true, true, true);
            npcContext.IncrementFact(Rust.Ai.HTN.ScientistAStar.Facts.Alertness, 2, true, true, true);
            return;
          }
        }
      }
      npcContext.SetFact(Rust.Ai.HTN.ScientistAStar.Facts.NearbyExplosives, false, true, true, true);
    }
  }
}
