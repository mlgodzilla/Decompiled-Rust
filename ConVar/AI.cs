...
namespace ConVar
{
  ...
  public class AI : ConsoleSystem
  {
    ...
    {
      LoadBalancedQueue managerLoadBalancer = AiManagerLoadBalancer.aiManagerLoadBalancer as LoadBalancedQueue;
      managerLoadBalancer?.set_defaultUpdateInterval(args.GetFloat(0, managerLoadBalancer.get_defaultUpdateInterval()));
    }
    ...
    {
      LoadBalancedQueue sensesLoadBalancer = NPCSensesLoadBalancer.NpcSensesLoadBalancer as LoadBalancedQueue;
